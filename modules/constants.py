...
GO_NO_POINTS = (
    ...
    'Перезапустите команду /start_race и снова пропишите команду /go. '
    'Если это сообщение появится вновь - организаторы еще не добавили '
    'контрольные точки'
)
...
POLLING_ERROR = 'Ошибка Updater при старте поллинга: {error}'
